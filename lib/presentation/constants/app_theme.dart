...
class AppThemeData {
  ...
  static ThemeData themeData(ColorScheme colorScheme, Color focusColor) {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: Colors.transparent, // 将导航栏颜色设置为透明
        elevation: 0,
        scrolledUnderElevation: 0.0,
        iconTheme: IconThemeData(color: colorScheme.primary),
        systemOverlayStyle: SystemUiOverlayStyle(
          statusBarColor: Colors.transparent,
          statusBarIconBrightness: Brightness.light, // 状态栏图标为亮色（白色）
          statusBarBrightness: Brightness.dark, // 状态栏亮度为暗色（适用于iOS）
        ),
      ),
  ...
  static const ColorScheme lightColorScheme = ColorScheme(
    primary: Color(0xFF70DEDC),
    primaryContainer: Color.fromARGB(255, 23, 158, 84),
