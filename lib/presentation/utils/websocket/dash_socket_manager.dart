...
//
// class ISocketIOManager {
//   static ISocketIOManager? _instance;
//   io.Socket? _socket;
...
//   late StreamController<ChatMessage> _updateController;
//
//   //late StreamController<List<User>> _usersController;
//   late List<ChatMessage> _roomMessages = [];
//
...
//
//   /// 获取单例实例（自动初始化）
//   factory ISocketIOManager() {
//     _instance ??= ISocketIOManager._();
...
//     _updateController = StreamController<ChatMessage>.broadcast();
...
//               medias.add(ChatMedia(
//                 url: '${Endpoints.baseUrl}${"/api/fileservice/file/preview/"}${attachment[i].code}',
//                 type: MediaType.file,
...
//
//   // 更新消息状态
//   void _updateMessageStatusNew(ChatMessage msg) {
...
//
//   // 添加消息到房间
//   void _addMessageToRoom(ChatMessage message) {
